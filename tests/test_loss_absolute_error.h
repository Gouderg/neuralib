...
class TestLossMeanAbsoluteError: public CxxTest::TestSuite {
    ...
    public:
        ...
        void testLossMeanAbsoluteErrorAccuracy(void) {
            TS_TRACE("Starting Loss_MeanAbsoluteErrorAccuracy test");
            ...
            TS_ASSERT_EQUALS(Loss_MeanAbsoluteError::accuracy(outputs, y_true, accuracy_precision), 0.5);
        }
};